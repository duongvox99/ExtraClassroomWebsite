...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2019 at 02:48 PM
...
(2, 'Đề kiểm tra lớp 10 tuần 47', 0, 1, '2019-11-22 19:30:40', 10, 47, 5, 3, 2, 15),
(4, 'Test lop 12', 0, 1, '2019-11-22 23:53:53', 12, 47, 5, 3, 2, 90);
...
--
-- Dumping data for table `de_cauhoi`
--
...
--
-- Dumping data for table `de_nhom`
--

INSERT INTO `de_nhom` (`IdNhom`, `IdDe`, `ThoiGianMo`, `ThoiGianDong`) VALUES
(1, 2, '2019-11-22 16:15:06', '2019-11-24 00:00:00'),
(7, 2, '2019-11-23 06:54:44', '2019-11-24 06:54:44'),
(7, 4, '2019-11-23 06:54:29', '2019-11-23 06:54:29');
...
--
-- Dumping data for table `diem_de`
--
...
(1, '<p>Hàm số y = 2sinxcosx + cos2x có giá trị lớn nhất là</p>', '<p>3</p>', '<p>2√2</p>', '<p>2</p>', '<p>√2</p>', 4, '<p>Ta có y = sin2xcos2x = √2 sin(2x + π/4) nên giá trị lớn nhất của hàm số là √2.</p>', 1, 11, 47),
(2, '<p>Hàm số y = (sinx – cosx)2 + cos2x có giá trị nhỏ nhất là:</p>', '<p>- 1</p>', '<p>1- √2</p>', '<p>0</p>', '<p>1 + √2</p>', 2, '<p style=\"text-align:justify;\">Ta có y = sin2x + cos2x -2sinxcosx + cos2x</p><p style=\"text-align:justify;\">= 1 – sin2x + cos2x = 1 - √2 sin(2x - π/4).</p><p style=\"text-align:justify;\">Từ đó suy ra giá trị nhỏ nhất của hàm số là 1 - √2.</p>', 1, 11, 47),
(3, '<p>Hàm số y = 2cos2x – 1 là hàm tuần hoàn với chu kì:</p>', '<p>T = π.</p>', '<p>T = 2π.</p>', '<p>T = π2.</p>', '<p>T = π/2.</p>', 1, '<p>Ta có y = 2cos2x – 1 = cos2x, do đó hàm số tuần hoàn với chu kì T = 2π/2 = π.</p>', 1, 11, 47),
(4, '<p>Hàm số y = sin(π/2-x) + cotx/3 là hàm tuần hoàn với chu kì:</p>', '<p>T = π.</p>', '<p>T = 2π.</p>', '<p>T = 3π.</p>', '<p>T = 6π.</p>', 4, '<p style=\"text-align:justify;\">Hàm số y1 = sin(π/2-x) có chu kì T1 = 2π/|-1| = 2π;</p><p style=\"text-align:justify;\">Hàm số y2 = cot(x/3) có chu kì T2 = 2π/|1/3| = 3 π. Suy ra hàm số đã cho y = y1 +y2 có chu kì T =BCNN(2,3).π = 6π.</p>', 1, 11, 47),
(5, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/aa33ab8656d4171726cb4727613a8c.png\"></figure><p>Hình vẽ bên là một phần đồ thị của hàm số nào sau đây?</p>', '<p>y = sinx/2</p>', '<p>y = cosx/2</p>', '<p>y = - cosx/4</p>', '<p>y = sin( - x/2)</p>', 4, '<p>Đồ thị hàm số đi qua gốc tọa độ nên loại ngay các phương án B và C. Đồ thị hàm số đi qua (π; -1) nên phương án A cũng không thỏa mãn.</p><p>Nhận xét: Từ đồ thị ta nhận thấy hàm số có chu kì T =4π nên ta có thể loại ngay phương án C.</p>', 1, 11, 47),
(6, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/c4f73a20e4fb87db15e8a74ec18f93.png\"></figure><p>Hình vẽ bên là một phần đồ thị của hàm số nào sau đây?</p>', '<p>y = sinx/2</p>', '<p>y = sinx</p>', '<p>y = cosx/2</p>', '<p>y = cosx</p>', 1, '<p>Từ đồ thị ta nhận thấy hàm số có chu kì T =4π loại 3 đáp án còn lại.</p>', 1, 11, 47),
(7, '<p>Hàm số y = cosx/(2sinx- √3) có tập xác định là:</p>', '<p>R{π/3+k2π, k ∈ Z}.</p>', '<p style=\"text-align:justify;\">R{π/6+kπ, k ∈ Z}.</p>', '<p>R{π/6+k2π, 5π/6+k2π, k ∈ Z}.</p>', '<p>R{π/3+k2π, 2π/3+k2π, k ∈ Z}.</p>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/44ead1234aaececdca7b4d814236ee.png\"></figure>', 1, 11, 47),
(8, '<p>Hàm số y = tan(x/2 - π/4) có tập xác định là:</p>', '<p>R{π/2+k2π, k ∈ Z}.</p>', '<p>R{π/2+kπ, k ∈ Z}.</p>', '<p>R{3π/2+k2π, k ∈ Z}.</p>', '<p>R.</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/22dd517a03cf9951f161a42ecd3154.png\"></figure>', 1, 11, 47),
(9, '<p>Tập xác định của hàm số y = cot(2x - π/3) + 2 là:</p>', '<p>R{π/6+kπ, k ∈ Z}.</p>', '<p>R{π/6+k2π, k ∈ Z}.</p>', '<p>R{5π/12+kπ/2, k ∈ Z}.</p>', '<p>R{π/6+kπ/2, k ∈ Z}.</p>', 4, '<p>Hàm số y= cot(2x-π/3)+2 xác định khi và chỉ khi sin(2x-π/3)≠0</p>', 1, 11, 47),
(10, '<p>Hàm số :</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/adeaa97dd07c3bc831d29f5b71dcc7.png\"></figure><p>có tập xác định là:</p>', '<p>R{kπ, k ∈ Z}.</p>', '<p>R{π/2+π, k ∈ Z}.</p>', '<p>R{π/2+k2π, k ∈ Z}.</p>', '<p>R{kπ/2, k ∈ Z}</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/6d68afab4f6df9700f68ce4a36e344.png\"></figure>', 1, 11, 47),
(11, '<p>Cho hàm số y = sinx/(1+tanx) và k ∈ Z.</p><p>Khoảng nào dưới đây không nằm trong tập xác định của hàm số?</p>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/5449249cbe06bf6eafe36b12f33163.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/6a31e7f8d9147f1dd5fd20ccc83249.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/644e189df3f4eeb3899eb072efa39c.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/064866a691a751e6ee44afce88b087.png\"></figure>', 1, '', 2, 11, 47),
(12, '<p>Hàm số :</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/bc93f9c42d236c2a02e3e63121d9e6.png\"></figure><p>có tập xác định là:</p>', '<p>R</p>', '<p>R{k2π, k ∈ Z}.</p>', '<p>{k2π, k ∈ Z}.</p>', '<p>∅</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/243c82784b26927785a40f179c6655.png\"></figure>', 2, 11, 47),
(13, '<p>Hàm số y = sinxcos2x là:</p>', '<p>Hàm chẵn.</p>', '<p>Hàm không có tính chẵn, lẻ.</p>', '<p>Hàm không có tính tuần hoàn.</p>', '<p>Hàm lẻ.</p>', 4, '<p>Do y= sinx là hàm lẻ, y=cos2x là hàm chẵn nên hàm số y= sinx cos2x là hàm lẻ</p>', 2, 11, 47),
(14, '<p>Hàm số y = tan3x/ sin3x thỏa mãn tính chất nào sau đây?</p>', '<p>Hàm chẵn.</p>', '<p>Hàm không có tính chẵn, lẻ.</p>', '<p>Xác định trên R.</p>', '<p>Hàm lẻ.</p>', 1, '<p>Do y=sinx và y=tan3x là hàm lẻ nên</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/3f545c60fb1fd0e5f11cece5131fa6.png\"></figure>', 2, 11, 47),
(15, '<p>Trong các hàm số sau, hàm số nào là hàm lẻ?</p>', '<p>y = sin2x</p>', '<p>y = sin2x.cosx.</p>', '<p>y = tanx/cosx.</p>', '<p>y = cotx/sinx.</p>', 3, '<p>Do y=tanx là hàm lẻ, y=cosx là hàm chẵn nên đáp án cần chọn là C</p>', 2, 11, 47),
(16, '<p>Trong các hàm số sau, hàm số nào là hàm chẵn?</p>', '<p>y = tan2x/ tan2x +1</p>', '<p>y = sinx.cos2x</p>', '<p>y = cosx.sin2x</p>', '<p>y = cosxsin3x.</p>', 3, '<p>Do y=sin2x và y= cosx là hàm chẵn&nbsp;</p>', 2, 11, 47),
(17, '<p>Trong các hàm số sau, hàm số nào không là hàm chẵn và cũng không là hàm lẻ?</p>', '<p>y = tanx - 1/sinx.</p>', '<p>y = √2 sin(x - π/4).</p>', '<p>y = sinx + tanx.</p>', '<p>y = sin4x – cos4x.</p>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ea1160cc3776c8f447e7a34484bc06.png\"></figure>', 2, 11, 47),
(18, '<p>Hàm số y = (sinx + cosx)2 + cos2x có giá trị lớn nhất là:</p>', '<p>1+√2 &nbsp;</p>', '<p>3</p>', '<p>5</p>', '<p>√2</p>', 1, '<p>Ta có y=(sinx+cosx)2 + cos2x = 1+ sin2x+ cos2x= 1+√2sin(2x+π/4), suy ra hàm số có giá trị lớn nhất là 1+√2</p>', 2, 11, 47),
(19, '<p>Hàm số y = √3sinx – cosx có giá trị nhỏ nhất là:</p>', '<p>1 – √3&nbsp;</p>', '<p>- √3</p>', '<p>– 2 &nbsp;</p>', '<p>– 1 – √3</p>', 3, '<p>Ta có y= √3 sinx- cosx</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/11b423430eded577fbdbe482691944.png\"></figure>', 2, 11, 47),
(20, '<p>Cho hàm số y = (cosx-1)/(cosx+2). Mệnh đề nào trong số các mệnh đề sau đây là sai?</p>', '<p>Tập xác định của hàm số là ℝ.</p>', '<p>Hàm số có giá trị lớn nhất bằng 0.</p>', '<p>Hàm số có giá trị nhỏ nhất bằng - 2.</p>', '<p>Hàm số tuần hoàn với chu kì T = 2.</p>', 4, '<p>Dễ nhận thấy đáp án A,B,C thỏa mãn nên đáp án cần chọn là D. Có thể nhận thấy ngay hàm số</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/6e2df2a069a8e37ead6c356a88fddd.png\"></figure>', 2, 11, 47),
...
(22, '<p>Giá trị nhỏ nhất của hàm số y = 3- 4sin2xcos2x là:</p>', '<p>– 1 &nbsp;</p>', '<p>2</p>', '<p>1 &nbsp;</p>', '<p>3</p>', 2, '<p>Ta có y= 3- 4sin2xcos2x= 3- sin22x≥2, dấu phẩy đẳng thức xảy ra khi sin22x= 1</p>', 3, 11, 47),
(23, '<p>Hàm số y = √(1-cos2x) có chu kì là:</p>', '<p>2π</p>', '<p>√2π</p>', '<p>π</p>', '<p>√π</p>', 3, '<p>Tập xác định của hàm số đã cho là R mà cos2x có chu kì là π nên y= √(1-cos2x) cũng có chu kì là π</p>', 3, 11, 47),
...
(28, '<p>Phương trình sin2x = 1 có nghiệm là:</p>', '<p>π/2+k4π, k ∈ Z.</p>', '<p>π/2+kπ, k ∈ Z.</p>', '<p>π/4+k2π, k ∈ Z.</p>', '<p>π/4+kπ, k ∈ Z.</p>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ebbc4b4edda2f8289c8371a483c66e.png\"></figure>', 3, 11, 47),
...
(31, '<p>Phương trình 2cosx - √3 = 0 có tập nghiệm trong khoảng (0;2π) là:</p>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/24d6a3254e97088bd97a5b97b6489d.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/22dec03c837a5fb7ef1ccd55cbb8b1.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/d7fb663332d5969db1e8a28c8654f4.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ab03b6002e5831e3f322a8a3c11611.png\"></figure>', 1, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/5d723e4c7f22a13a740134adc9837a.png\"></figure><p>Do x ∈ (0;2π) nên tập nghiệm của phương trình là {π/6; 11π/6}&nbsp;</p>', 4, 11, 47),
(32, '<p>Phương trình sin(πcos2x) = 1 có nghiệm là:</p>', '<p>x = kπ, k ∈ Z.</p>', '<p>π+k2π, k ∈ Z.</p>', '<p>π/2+kπ, k ∈ Z.</p>', '<p>±π/6+kπ, k ∈ Z.</p>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/22616957117ccbd81d326b232588b7.png\"></figure>', 4, 11, 47),
(33, '<p>Phương trình cosx/2 = - 1 có nghiệm là:</p>', '<p>x = 2π + k4π, k ∈ Z.</p>', '<p>x = k2π, k ∈ Z.</p>', '<p>x = π + k2π, k ∈ Z.</p>', '<p>x = 2π + kπ, k ∈ Z.</p>', 1, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/4b935fa9069246b045a0487ae51e03.png\"></figure>', 4, 11, 47),
(34, '<p>Phương trình cos23x = 1 có nghiệm là:</p>', '<p>x = kπ, k ∈ Z.</p>', '<p>x =kπ/2, k ∈ Z.</p>', '<p>x =kπ/3, k ∈ Z.&nbsp;&nbsp;</p>', '<p>x =kπ/4, k ∈ Z.</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/d4e501975e1c615406d34d78528212.png\"></figure>', 4, 11, 47),
(35, '<p>Phương trình tan( x - π/4) = 0 có nghiệm là:</p>', '<p>x = π/4 + kπ, k ∈ Z.</p>', '<p>x = 3π/4 + kπ, k ∈ Z.</p>', '<p>x = kπ, k ∈ Z.&nbsp;</p>', '<p>x = k2π, k ∈ Z.</p>', 1, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/932c828205b63ff7b6878d9c80b1af.png\"></figure>', 4, 11, 47),
(36, '<p>Phương trình cot( x + π/4) = 0 có nghiệm là:</p>', '<p>x = - π/4 + kπ, k ∈ Z.</p>', '<p>x = π/4 + kπ, k ∈ Z.</p>', '<p>x = - π/4 + k2π, k ∈ Z.&nbsp;</p>', '<p>x = π/4 + k2π, k ∈ Z.</p>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/4f941b5233baf143644bb30bf0a9ad.png\"></figure>', 4, 11, 47),
(37, '<p>Trong [0;π],phương trình sinx = 1 – cos2x có tập nghiệm là:</p>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/23569c1ea87d6b566f7f1e6d4823ee.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/8bfd1232e183052611829faf31f5fe.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/afc297cf885b681c5a6e0199a6da66.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/bd113e840a599be71fc8f20e0ef8b7.png\"></figure>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/3078afc9052dd844ec34ab87b275ba.png\"></figure><p>x ∈ [0;π]</p>', 4, 11, 47),
...
(39, '<p>Phương trình sinx + √3cosx = 1 có số nghiệm thuộc (0;3π) là:</p>', '<p>2&nbsp;</p>', '<p>3</p>', '<p>4&nbsp;</p>', '<p>6</p>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/5e0333464e775c806045bab2e149ed.png\"></figure>', 4, 11, 47),
(40, '<p>Số nghiệm của phương trình:</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/8487c90f3d37982926199e912cb04b.png\"></figure>', '<p>0&nbsp;</p>', '<p>2</p>', '<p>1</p>', '<p>3</p>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/be0021bb886df79229c25ea06f8f39.png\"></figure>', 4, 11, 47),
(41, '<p>Số nghiệm của phương trình:</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/9eafd3c747238dd591d2299492cf0e.png\"></figure>', '<p>0&nbsp;</p>', '<p>2</p>', '<p>1</p>', '<p>3</p>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/5d2cb7c0230ecb69c1d370711257de.png\"></figure>', 4, 11, 47),
(42, '<p>Số nghiệm của phương trình sin(x + π/4) = 1 thuộc [0;3π] là:</p>', '<p>1</p>', '<p>0</p>', '<p>2</p>', '<p>3</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/09501e1a86fc59153032597ec52496.png\"></figure>', 5, 11, 47),
(43, '<p>Trong các phương trình sau, phương trình nào có nghiệm?</p>', '<p>√3sinx = 2</p>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ef3cd258931fb5f30746dd66f30925.png\"></figure>', '<p>2sinx + 3cosx =1</p>', '<p>Cot2x – cotx +5 = 0</p>', 3, '<p>do 22 + 32 &gt; 12</p>', 5, 11, 47),
(44, '<p>Trong các phương trình sau, phương trình nào vô nghiệm?</p>', '<p>sin2x – cos2x = 1</p>', '<p>sin2x – cosx = 0</p>', '<p>sinx = 2π/5</p>', '<p>sinx - √3cosx = 0</p>', 3, '<p>do 2π/5 &gt; 1</p>', 5, 11, 47),
(45, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/f6785a28fa0aa3be92289606aaf6f9.png\"></figure>', '<p>{2π/3}</p>', '<p>{3π/2}</p>', '<p>{π/3; 2π/3}&nbsp;</p>', '<p>{π/2; 3π/2}</p>', 1, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/abc00ac94edf935a2745fc1d091477.png\"></figure>', 5, 11, 47),
(46, '<p>Tập nghiệm của phương trình cos2x – cos2x = 0 trong khoảng [0;2π) là:</p>', '<p>{0;π}&nbsp;</p>', '<p>{0;π/2}</p>', '<p>{π/2; 3π/2}&nbsp;</p>', '<p>{0; 3π/2}</p>', 1, '<p>Ta có cos2x – cos2x= 0 ↔ sin2x=0 ↔ x= kπ, k∈Z. Tập nghiệm của phương trình cos2x– cos2x= 0 trong khoảng [0,2π) là {0; π}</p>', 5, 11, 47),
(47, '<p>Phương trình cos(πsinx) = 1 có nghiệm là:</p>', '<p>x = kπ, k ∈ Z.</p>', '<p>x = π + k2π, k ∈ Z.</p>', '<p>π/2+kπ, k ∈ Z.</p>', '<p>π/4+kπ, k ∈ Z.</p>', 1, '<p>Ta có cos( πsinx) = 1 ↔ πsinx = k2π ↔ sinx = 2k, k ∈ Z. Do -1≤ sinx ≤1 nên k = 0 → sinx = 0 → x = kπ, k ∈ Z</p>', 5, 11, 47),
(48, '<p>Phương trình cos(πcos3x) = 1 có nghiệm là:</p>', '<p>x = π/8+k π/4, k ∈ Z.</p>', '<p>x = π/4+k π/2, k ∈ Z.</p>', '<p>x = π/6+k π/3, k ∈ Z.</p>', '<p>x = π/2+kπ, k ∈ Z.</p>', 3, '<p>Ta có cos(πcos3x)=1 ↔ πcos3x= k2π ↔ cos3x= 2k, k∈Z. Do -1≤cos3x≤1 nên k=0 → cos3x= 0 → 3x= π/2+kπ, k∈Z</p>', 5, 11, 47),
(49, '<p>Phương trình</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/d6a19631533b156246d5e37313158d.png\"></figure><p>có tập nghiệm là:</p>', '<p>{π/2+kπ, k ∈ Z}&nbsp;</p>', '<p>{π/2+k2π, k ∈ Z}</p>', '<p>∅</p>', '<p>{-π/2+k2π, k ∈ Z}</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/a36a6967186ba19d20483421f33827.png\"></figure><p>từ đó suy ra phương trình vô nghiệm</p>', 5, 11, 47),
...
(51, '<p>{-6; -3; 0; 3; 6; 9}</p>', '<p>{-6; -3; 0; 3; 6; 9}</p>', '<p>{5,3,4,2,9,7}</p>', '<p>{-3; 0; 3; 6; 9}</p>', '<p>{-1; 0; 1; 2; 3}</p>', 1, '<p style=\"text-align:justify;\">A={3k|k ∈ N,-2 &lt; k ≤ 3}</p><p style=\"text-align:justify;\">k ∈ N,-2 &lt; k ≤ 3 ⇒ k ∈ {-1;0;1;2;3}</p><p style=\"text-align:justify;\">⇒ 3k ∈ {-3;0;3;6;9}</p>', 1, 10, 47),
...
(54, '<p>Cho hai tập hợp:A=(-∞;-3) ∪ [2; +∞) và B=(-5;4). Tính A ∩ B</p>', '<p>(-3;2)</p>', '<p>(-5; -3) ∪ [2;4)</p>', '<p>(-∞;-5) ∪ {2;4}</p>', '<p>(-5;2)</p>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/1008b23e0e8f26dc153dfa18063842.png\"></figure>', 1, 10, 47),
(55, '<p>Số phần tử của tập hợp A={x ∈ R|(x2 - x)(x4 - 4x2 + 3)= 0} là</p>', '<p>6</p>', '<p>2</p>', '<p>3</p>', '<p>5</p>', 4, '<p>A={x ∈ R|(x2 - x)(x4 - 4x2 + 3)= 0}</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/b0335bd7a83125607ba716cfdb0c11.png\"></figure><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ed07bf7a91d7c03637412d23226866.png\"></figure>', 1, 10, 47),
...
(58, '<p>Cho hai tập hợp: E={x ∈ R|f(x)=0},F={x ∈ R| g(x)=0}, và tập hợp</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/24da2a9638d9489edaf8a712cf509b.png\"></figure>', '<p>Q=E ∩ F</p>', '<p>Q=E ∪ F</p>', '<p>Q=EF</p>', '<p>Q=FE</p>', 4, '<p>E={x ∈ R|f(x)=0},F={x ∈ R| g(x)=0},</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/c8a6d231d72ffb9ff36cdfcef21c96.png\"></figure>', 1, 10, 47),
...
(60, '<p>Cho hai tập hợp:A=[m;m + 2],B=[2m - 1;2m + 3]. .A ∩ B ≠ ∅ khi và chỉ khi:</p>', '<p>-3 &lt; m &lt;3</p>', '<p>-3 &lt; m ≤ 3</p>', '<p>-3 ≤ m &lt;3</p>', '<p>-3 ≤ m ≤ 3</p>', 4, '<p>Giả sử A ∩ B= ∅ ⇒</p><figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/30054bf54f9415c015a5ff13e64ae6.png\"></figure><p>⇒ A ∩ B≠ ∅ ⇔-3 ≤ m ≤ 3.</p>', 1, 10, 47),
...
(72, '<p>Trong các hoạt động sau đây, hoạt động nào không liên quan đến thống kê?</p>', '<p>Thu thập số liệu</p>', '<p>Phân tích các số liệu&nbsp; thu thập được</p>', '<p>Xử lí các số liệu thu thập được</p>', '<p>Ra quyết định dựa trên số liệu</p>', 4, '<p>Thống kê là khoa học nghiên cứu các phương pháp thu thập; phân tích và xử lí các số liệu</p>', 3, 10, 47),
...
(92, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/3dbccdd5f0b8c588cf6000aed15552.png\"></figure>', '<p>167</p>', '<p>168</p>', '<p>169</p>', '<p>164</p>', 2, '<p>Độ dài mỗi lớp là: 162-160= 2.</p><p>Do đó số cần tìm là: 166+ 2= 168</p>', 5, 10, 47),
(93, '<p>Cho bảng tần số, tần suất ghép lớp như câu 22. Hãy điền số thích hợp vào**</p>', '<p>10</p>', '<p>12</p>', '<p>8</p>', '<p>13</p>', 1, '<p>Ta có; kích thước mẫu là 36.</p><p>Mà tổng các tần số bằng kích thước mẫu.</p><p>Do đó; số cần tìm là:</p><p>36- ( 6+12+5+3) = 10.</p>', 5, 10, 47),
(94, '<p>Cho bảng tần số, tần suất ghép lớp như câu 22. Hãy điền số thích hợp vào</p>', '<p>3,9%</p>', '<p>5,9%</p>', '<p>13,9%</p>', '<p>23,9%</p>', 3, '<p>Áp dụng công thức tính tần suất ta có tần suất của lớp thứ 4 là:</p><p>&nbsp;&nbsp;&nbsp;<math xmlns=\"http://www.w3.org/1998/Math/MathML\" id=\"MathJax-Element-1-Frame\"><mfrac><mn>5</mn><mn>36</mn></mfrac><mo>.</mo><mn>100</mn><mo>%</mo></math>&nbsp;= &nbsp; 13,9 %</p>', 5, 10, 47),
(95, '<p>Trong các điều khẳng định sau:</p><p style=\"text-align:justify;\">(1) Thống kê là khoa học về các phương pháp thu thập, tổ chức, trình bày, phân tích và xử lí dữ liệu.</p><p style=\"text-align:justify;\">(2) Số lần xuất hiện của một giá trị trong dãy giá trị của dấu hiệu được gọi là tần số của giá trị đó.</p><p style=\"text-align:justify;\">(3) Giá trị có tần số lớn nhất gọi là mốt của dấu hiệu.</p><p>(4) Độ lệch chuẩn là bình phương của phương sai.</p><p>Có bao nhiêu khẳng định đúng:</p>', '<p>1</p>', '<p>2</p>', '<p>3</p>', '<p>4</p>', 3, '<p>Các khẳng định đúng là: (1) ; (2); (3)</p><p>(4) cần sửa thành: Phương sai là bình phương của độ lệch chuẩn.</p>', 5, 10, 47),
...
(97, '<p>Cho bất phương trình:&nbsp;<math xmlns=\"http://www.w3.org/1998/Math/MathML\" id=\"MathJax-Element-1-Frame\"><mfenced close=\"|\" open=\"|\"><mfrac><mn>2</mn><mrow><mi>x</mi><mo>-</mo><mn>13</mn></mrow></mfrac></mfenced><mo>&gt;</mo><mfrac><mn>8</mn><mn>9</mn></mfrac></math>. Số các nghiệm nguyên của bất phương trình là:</p>', '<p>2&nbsp;</p>', '<p>3</p>', '<p>4</p>', '<p>5</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/03d573d19fc653cf321e471cf06567.png\"></figure>', 5, 10, 47),
(98, '<p>Cho bất phương trình:&nbsp;m(x−m)≥x−1<math xmlns=\"http://www.w3.org/1998/Math/MathML\" id=\"MathJax-Element-1-Frame\"><mi mathvariant=\"normal\">m</mi><mo>(</mo><mi mathvariant=\"normal\">x</mi><mo>-</mo><mi mathvariant=\"normal\">m</mi><mo>)</mo><mo>≥</mo><mi mathvariant=\"normal\">x</mi><mo>-</mo><mn>1</mn></math></p><p>Các giá trị nào sau đây của m thì tập nghiệm của bất phương trình là&nbsp; S=(−∞;m+1]</p>', '<p>m= 1</p>', '<p>m&gt; 1</p>', '<p>&nbsp;m&lt; 1</p>', '<p>&nbsp;m≥1</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/43a75f808828e54893fdc370a05d1e.png\"></figure>', 5, 10, 47),
(99, '<p>Cho bất phương trình: mx+ 6&lt; 2x+3m .</p><p>Tập nào sau đây là phần bù của tập nghiệm của bất phương trình trên với m&lt; 2 :</p>', '<p><strong>S=(3;+∞)</strong></p>', '<p>S=[3;+∞)</p>', '<p><strong>S&nbsp;=&nbsp;(−∞;3)</strong></p>', '<p><br><strong>S=(−∞;3]</strong></p>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/9896cff4f26952db2d22a0bfae50f6.png\"></figure>', 5, 10, 47),
(100, '<p>Với giá trị nào của m thì bất phương trình&nbsp;<math xmlns=\"http://www.w3.org/1998/Math/MathML\" id=\"MathJax-Element-1-Frame\"><mo>(</mo><msup><mi mathvariant=\"normal\">m</mi><mn>2</mn></msup><mo>+</mo><mi mathvariant=\"normal\">m</mi><mo>+</mo><mn>1</mn><mo>)</mo><mi mathvariant=\"normal\">x</mi><mo>&nbsp;</mo><mo>-</mo><mn>5</mn><mi mathvariant=\"normal\">m</mi><mo>&nbsp;</mo><mo>≥</mo><mo>(</mo><msup><mi mathvariant=\"normal\">m</mi><mn>2</mn></msup><mo>+</mo><mn>2</mn><mo>)</mo><mi mathvariant=\"normal\">x</mi><mo>-</mo><mn>3</mn><mi mathvariant=\"normal\">m</mi><mo>-</mo><mn>1</mn></math>vô nghiệm ?</p>', '<p>m &gt;&nbsp; 1</p>', '<p>m = 1</p>', '<p>m &lt; 1</p>', '<p>m ≤ 1</p>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/f935fad48cf0be3a85fcb5f03084c2.png\"></figure>', 5, 10, 47),
...
(106, '<p>Cho a + b = 1 &nbsp;thì&nbsp;<math class=\"mjx-chtml MathJax_CHTML\" xmlns=\"http://www.w3.org/1998/Math/MathML\" id=\"MathJax-Element-1-Frame\"><mfrac><msup><mn>4</mn><mi mathvariant=\"normal\">a</mi></msup><mrow><msup><mn>4</mn><mi mathvariant=\"normal\">a</mi></msup><mo>+</mo><mn>2</mn></mrow></mfrac><mo>+</mo><mfrac><msup><mn>4</mn><mi mathvariant=\"normal\">b</mi></msup><mrow><msup><mn>4</mn><mi mathvariant=\"normal\">b</mi></msup><mo>+</mo><mn>2</mn></mrow></mfrac></math>&nbsp;bằng</p>', '<p>4</p>', '<p>2</p>', '<p>3</p>', '<p>1</p>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/8b5edc220b1b1d5517480c8b4bc825.png\"></figure>', 1, 12, 47),
...
(113, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/b15b4e1d92a0e5af215742853d4779.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/64c5290d5981bbbce2d1ab00c7dcff.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/6122f9ff55241e7945bfd189a58a94.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/23de8dc24d7939ff3d5a0337365928.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/2c29fe9df802489a930eeed8b350e5.png\"></figure>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/05a23cb047063a94da5e2e4a42b42a.png\"></figure>', 2, 12, 47),
(114, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/a691662069e8ad3a6f17503b1133bf.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/9ebcd290ea7f3f956cadb8478242e8.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/4e3c25b089021a1d8c82b09ee86986.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ab52105d1199366a238403948c9016.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/558d6e13a3462ad1698a6013397b98.png\"></figure>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/6f38409d63278a073e2b12e0f88db0.png\"></figure>', 2, 12, 47),
...
(124, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/21a7d8929a376cc746bdfdab548a10.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/6a01b8ed09c17a1a7812867b1ce329.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/4feb44ef916c24a214f326fdde43d4.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/a7c8b50ae1fe087986f236480c5ab6.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/e532bf317ad5777d5e02853f5caf11.png\"></figure>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/c3741d1d08d0d4d19a78474f9f6522.png\"></figure>', 3, 12, 47),
...
(131, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/a3062275c64bab8eee1fe627a8513d.png\"></figure>', '<p>3</p>', '<p>2</p>', '<p>4</p>', '<p>1</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/24dc9c7027978fadc7b227ca8b953e.png\"></figure>', 4, 12, 47),
(132, '<p>Cho số phức z; w thỏa mãn |z – 1 + 2i| = |z + 5i| ; w = iz + 20. &nbsp;Giá trị nhỏ nhất m của |w| là?</p><p><br><br data-cke-filler=\"true\"></p>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/b9231dab389a9293b6141f41c2d356.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/2ea9a92ff9f71d508b2296ca1aa77a.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/5a6d0735b129c6eb1709020d3a737a.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ec478c4b8f9b8e3b8572ff9fdeca64.png\"></figure>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/2abd44c0d187f7c61d0a5b373b154a.png\"></figure>', 4, 12, 47),
(133, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/90caa1b787aa7554bdbc1901447c9e.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/2e0e0d6d0037f4ab527dd13e9f2b6e.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/3a9aaea8612a97c41d41e523047329.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/2b252dcea2c225aa6725a07695f03a.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/e25c2007cccf844d9f36bdf78e1176.png\"></figure>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/70b5ec172b91c701d26d10306b0f6c.png\"></figure>', 4, 12, 47),
(134, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/62b99172dbae811d299423cdf16761.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/5d7a3e22b7c5fd9426e7d2b0549453.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/d7f29b1de01925e7478f6f6ff6fc8e.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/3642c41cf147b6de6f94845652985d.png\"></figure>', '<p>Đáp án khác.</p>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/d6d02e9dddc3cc04241110fc116121.png\"></figure>', 4, 12, 47),
(135, '<p>Cho số phức z &nbsp;thoả mãn |z – 1 + 3i| + |z + 2 – i| = 8. Tìm giá trị lớn nhất, giá trị nhỏ nhất của P = |2z + 1 = 2i|.</p>', '<p>8 và 4</p>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/3deb497b2ef615190ec088a48504de.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/18946f857581ed55a86e81cefcc5a3.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/5baa07f4530c54ac0b0e0d355a4384.png\"></figure>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/22935bf4c5a508f21f2569b48cac2e.png\"></figure>', 4, 12, 47),
(136, '<p>Cho số phức&nbsp; z thỏa mãn |z – 2 – 3i| = 1. Tìm giá trị lớn nhất của |z|?</p>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/d3bc323dcc54eaf3181a0819e7e1eb.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/55c229a212651730c9a561b93df844.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ddaeaec2dcd7544cd3d806addb93b6.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/77576950af2ab7d9de05a6dfbd4349.png\"></figure>', 1, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/6b7e6083bc0c2d94170dc2f04cbf71.png\"></figure>', 4, 12, 47),
(137, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/c2fd804d201765ed7b5c623618bde7.png\"></figure>', '<p>34</p>', '<p>82</p>', '<p>68</p>', '<p>36</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/17b4c149de0f494588269ecf6d8223.png\"></figure>', 4, 12, 47),
(138, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/a92646b1b3cc0f091f2079378f6514.png\"></figure>', '<p>4</p>', '<p>3</p>', '<p>7</p>', '<p>6</p>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ddb2a97efd00d953677a27de8e49ff.png\"></figure>', 4, 12, 47),
(139, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/18ffb44006342786997367981fd051.png\"></figure>', '<p>d(I; Oy) = 1.</p>', '<p><strong>&nbsp;</strong>d(I&nbsp;; Oy) = 2</p>', '<p>d(I&nbsp;; Oy) = 0.</p>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/34c49142f137903c4b0841988ec1e6.png\"></figure>', 1, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/20b40d9d94bfac053d6d1b3191f058.png\"></figure>', 4, 12, 47),
(140, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/a26f4d6619db4a9b91872579231326.png\"></figure>', '<p>Số phức z = a + bi; |z| ≤ 2; -1&nbsp;≤ a&nbsp;≤ 1.</p>', '<p>Số phức&nbsp;z = a + bi; |z| ≤&nbsp;2; a &lt; -1; a &gt; 1.</p>', '<p>Số phức z = a + bi; |z| &lt; 2; -1 ≤ a ≤ 1.</p>', '<p>Số phức z = a + bi; |z| ≤ 2; -1 ≤ b ≤ 1.</p>', 1, '<p>+ Từ hình biểu diễn ta thấy tập hợp các điểm M(a; b) biểu diễn số phức <i>z</i> trong phần gạch chéo đều thuộc đường tròn tâm O(0;0) và bán kính bằng 2; ngoài ra -1 ≤ &nbsp;a ≤ 1.</p><p>+ Vậy M(a; b) là điểm biểu diễn của các số phức z = a + bi &nbsp;có mô đun nhỏ hơn hoặc bằng 2 và có phần thực thuộc đoạn [-1;1].</p>', 4, 12, 47),
(141, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ab02488fe8ec0c63a80051c3474396.png\"></figure>', '<p>1 ≤ |z| ≤ 2 và phần ảo dương.</p>', '<p>1 ≤ |z| ≤ 2 và phần ảo âm.</p>', '<p>1 &lt; |z| &lt; 2 và phần ảo dương.</p>', '<p>1 &lt; |z| &lt; 2 &nbsp;và phần ảo âm.</p>', 2, '<p>Ta thấy phần tô màu là nửa dưới trục hoành của hình vành khăn được tạo bởi hai đường tròn đồng tâm O(0&nbsp;;0) và bán kính lần lượt là 1 và 2.</p><p>Vậy đây chính là tập hợp các điểm M(x; y) biểu diễn cho số phức z = x + yi&nbsp; trong mặt phẳng phức với 1 ≤ |z| ≤ 2 và có phần ảo âm.</p>', 4, 12, 47),
(142, '<p>Cho số phức z thỏa mãn |z – 4| + |z + 4| = 10. Giá trị lớn nhất và nhỏ nhất của mô – đun của số phức z là</p>', '<p>10 và 4</p>', '<p>5<strong>&nbsp;</strong>và 4</p>', '<p>4<strong>&nbsp;</strong>và 3</p>', '<p>5&nbsp;và 3</p>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/4d33e0e41503a4961dfe51f432f848.png\"></figure>', 5, 12, 47),
...
(144, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/850d2c32aa271b7fcc23671cd68981.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/0020f7036c0eac07e1cecc0a01d435.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/25dd90c06e30e639c9c3beab7eabb9.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/765c26d41b3ec17e1e9acba0f6762d.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/d0e03fb4e629570cabeee499010bb2.png\"></figure>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/a5b476e2fb6bcda7ab4fe3ba08ba21.png\"></figure>', 5, 12, 47),
(145, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/b86723012fdb7d1c0296868f7fe6ef.png\"></figure>', '<p>1,17</p>', '<p>1,16</p>', '<p>1,15</p>', '<p>1,14</p>', 1, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/701ae81c276bc62c4ccec9d9a4754c.png\"></figure>', 5, 12, 47),
(146, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/d27194e77707c7a58bc9ef51f5cf5c.png\"></figure>', '<p>z = 1+ 2i</p>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/13a1fc2fd79bcc0c45c05e4b350d16.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/193f62166d7a92a7c3613ee86d2a75.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/5608be751e6de7156861f94f1a99ef.png\"></figure>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/60bdd77320dfcad6ff9530bb790e5c.png\"></figure>', 5, 12, 47),
(147, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/01b4ac443e37124813d4375b168f53.png\"></figure>', '<p>z = 2 hoặc – 2</p>', '<p>z= 3 hoặc – 3&nbsp; &nbsp; &nbsp;&nbsp;</p>', '<p>z = 4 hoặc – 4&nbsp;&nbsp;</p>', '<p>tất cả sai</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/ff0ecf27d451aad8b5f71a245144dd.png\"></figure>', 5, 12, 47),
(148, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/450d9f999cec74d00208f632923137.png\"></figure>', '<p>z = 1</p>', '<p>z = 1 - i&nbsp;</p>', '<p>z = -1 - i</p>', '<p>z = 2 - i</p>', 3, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/189a6e83e77ea0d20846eed5222e77.png\"></figure>', 5, 12, 47),
(149, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/fc691e41904da95bfbc8ec67a1a568.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/98bbf8dc52be91de9b0247241c3845.png\"></figure>', '<p>2</p>', '<p>1</p>', '<p>3</p>', 2, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/1ca10ffd3b37629f09e8612bd3abe3.png\"></figure>', 5, 12, 47),
(150, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/fe7fc12f857952196cb055552d93ce.png\"></figure>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/bc61d024d7283f3089ff37dc4ab0e6.png\"></figure>', '<p>4</p>', '<p>6</p>', '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/84f0115d3c1aaaa3acb5fecabd6daf.png\"></figure>', 4, '<figure class=\"image\"><img src=\"/ExtraClassroomWebsite/upload/nganhangcauhoi/531efe15677bd36080c2aa44d35846.png\"></figure>', 5, 12, 47);
-- --------------------------------------------------------
